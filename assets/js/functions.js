...
function submit_feedback(){
  ...
  xmlhttp.open("POST", "https://s.proxy-bay.click/pb_feedback_mail.php", true);
...
function submit_report(){
  ...
  xmlhttp.open("GET", "https://s.proxy-bay.click/pb_report.php?reportedUrl="+reportedUrl+'&feedbackVal='+feedbackVal, true);
  xmlhttp.send();
}
