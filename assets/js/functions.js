...
function submit_feedback(){
  ...
  xmlhttp.open("POST", "https://s.proxy-bay.mov/pb_feedback_mail.php", true);
...
function submit_report(){
  ...
  xmlhttp.open("GET", "https://s.proxy-bay.mov/pb_report.php?reportedUrl="+reportedUrl+'&feedbackVal='+feedbackVal, true);
  xmlhttp.send();
}
