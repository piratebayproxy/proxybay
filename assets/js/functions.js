...
function submit_feedback(){
  ...
  xmlhttp.open("POST", "https://contact.unblockit.esq/pb_feedback_mail.php", true);
...
function submit_report(){
  ...
  xmlhttp.open("GET", "https://contact.unblockit.esq/pb_report.php?reportedUrl="+reportedUrl+'&feedbackVal='+feedbackVal, true);
  xmlhttp.send();
}
